...
class AuthenticationTest extends TestCase
{
    ...
    public function test_business_users_can_authenticate_using_the_login_screen(): void
    {
    ...
    public function test_business_users_can_not_authenticate_with_invalid_password(): void
    {
        $user = $this->createUser('BUSINESS');
